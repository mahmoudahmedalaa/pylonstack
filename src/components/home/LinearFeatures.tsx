          ...
          <GlowCard className="md:col-span-1 lg:col-span-1" glowColor="rgba(16, 185, 129, 0.15)">
            <div className="flex h-[500px] flex-col p-12 lg:p-8 xl:p-12">
              ...
              <div className="relative mt-12 flex h-full w-full items-end justify-center pb-6">
                ...
                <div className="absolute top-2 left-8 rounded-lg border border-white/10 bg-[#10b981]/10 px-4 py-2 font-mono text-xl font-bold tracking-tight text-emerald-400 shadow-[0_0_30px_rgba(16,185,129,0.3)] backdrop-blur-xl">
                  -$42k
                </div>
              </div>
            </div>
